...
const file_steammessages_oauth_steamworkssdk_proto_rawDesc = "" +
	...
	"\n" +
	"OAuthToken\x12|\n" +
	"\x15ImplicitGrantNoPrompt\x12/.dota.COAuthToken_ImplicitGrantNoPrompt_Request\x1a0.dota.COAuthToken_ImplicitGrantNoPrompt_Response\"\x00B%Z#dota2-collector/parser/internal/valve;dota"
