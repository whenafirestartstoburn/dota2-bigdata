...
const file_dota_scenariomessages_proto_rawDesc = "" +
	"\n" +
	...
	".ultimate_scepter_consumed_alchemist_bonus_mana\x18z \x01(\x05R)ultimateScepterConsumedAlchemistBonusManaB-Z+dota2-collector/parser/internal/valve;valve"
