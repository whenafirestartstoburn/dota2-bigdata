...
type CMsgSource2PlayStatsPackedRecordList struct {
	...
	Uint64Vals               []uint64                                            `protobuf:"varint,4,rep,name=uint64_vals,json=uint64Vals" json:"uint64_vals,omitempty"`
	Uint32Vals               []uint32                                            `protobuf:"varint,5,rep,name=uint32_vals,json=uint32Vals" json:"uint32_vals,omitempty"`
	Uint16Vals               []uint32                                            `protobuf:"varint,6,rep,name=uint16_vals,json=uint16Vals" json:"uint16_vals,omitempty"`
	Uint8Vals                []uint32                                            `protobuf:"varint,7,rep,name=uint8_vals,json=uint8Vals" json:"uint8_vals,omitempty"`
	Int64Vals                []int64                                             `protobuf:"varint,8,rep,name=int64_vals,json=int64Vals" json:"int64_vals,omitempty"`
	Int32Vals                []int32                                             `protobuf:"varint,9,rep,name=int32_vals,json=int32Vals" json:"int32_vals,omitempty"`
	Int16Vals                []int32                                             `protobuf:"varint,10,rep,name=int16_vals,json=int16Vals" json:"int16_vals,omitempty"`
	Int8Vals                 []int32                                             `protobuf:"varint,11,rep,name=int8_vals,json=int8Vals" json:"int8_vals,omitempty"`
	Float64Vals              []float64                                           `protobuf:"fixed64,12,rep,name=float64_vals,json=float64Vals" json:"float64_vals,omitempty"`
	Float32Vals              []float32                                           `protobuf:"fixed32,13,rep,name=float32_vals,json=float32Vals" json:"float32_vals,omitempty"`
	BoolVals                 []bool                                              `protobuf:"varint,14,rep,name=bool_vals,json=boolVals" json:"bool_vals,omitempty"`
	...
	UtcdatetimeVals          []uint32                                            `protobuf:"fixed32,17,rep,name=utcdatetime_vals,json=utcdatetimeVals" json:"utcdatetime_vals,omitempty"`
	SteamidtrustbucketVals   []uint64                                            `protobuf:"fixed64,18,rep,name=steamidtrustbucket_vals,json=steamidtrustbucketVals" json:"steamidtrustbucket_vals,omitempty"`
...
type CMsgSource2PlayStatsPackedRecordList_FieldDef struct {
	...
	FieldType     *ESource2PlayStatsFieldType `protobuf:"varint,2,opt,name=field_type,json=fieldType,enum=dota.ESource2PlayStatsFieldType" json:"field_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CMsgSource2PlayStatsPackedRecordList_FieldDef) GetFieldType() ESource2PlayStatsFieldType {
	...
	return ESource2PlayStatsFieldType_Source2PlayStats_Invalid
}

type CMsgSource2PlayStatsPackedRecordList_SteamIDList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Steamid       []uint64               `protobuf:"fixed64,1,rep,name=steamid" json:"steamid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_source2_steam_stats_proto_rawDesc = "" +
	"\n" +
	"\x19source2_steam_stats.proto\x12\x04dota\"\xfe\x04\n" +
	...
	"\tmax_value\x18\x02 \x01(\rR\bmaxValue\"\xfb\x05\n" +
	...
	"\fperf_samples\x18\v \x03(\v2#.dota.CMsgSource2PerfIntervalSampleR\vperfSamples\"\xd9\a\n" +
	"$CMsgSource2PlayStatsPackedRecordList\x12\x1f\n" +
	"\vrecord_name\x18\x01 \x01(\tR\n" +
	"recordName\x12R\n" +
	"\n" +
	"field_defs\x18\x02 \x03(\v23.dota.CMsgSource2PlayStatsPackedRecordList.FieldDefR\tfieldDefs\x12!\n" +
	"\frecord_count\x18\x03 \x01(\rR\vrecordCount\x12\x1f\n" +
	"\vuint64_vals\x18\x04 \x03(\x04R\n" +
	"uint64Vals\x12\x1f\n" +
	"\vuint32_vals\x18\x05 \x03(\rR\n" +
	"uint32Vals\x12\x1f\n" +
	"\vuint16_vals\x18\x06 \x03(\rR\n" +
	"uint16Vals\x12\x1d\n" +
	"\n" +
	"uint8_vals\x18\a \x03(\rR\tuint8Vals\x12\x1d\n" +
	"\n" +
	"int64_vals\x18\b \x03(\x03R\tint64Vals\x12\x1d\n" +
	"\n" +
	"int32_vals\x18\t \x03(\x05R\tint32Vals\x12\x1d\n" +
	"\n" +
	"int16_vals\x18\n" +
	" \x03(\x05R\tint16Vals\x12\x1b\n" +
	"\tint8_vals\x18\v \x03(\x05R\bint8Vals\x12!\n" +
	"\ffloat64_vals\x18\f \x03(\x01R\vfloat64Vals\x12!\n" +
	"\ffloat32_vals\x18\r \x03(\x02R\vfloat32Vals\x12\x1b\n" +
	"\tbool_vals\x18\x0e \x03(\bR\bboolVals\x12\x1f\n" +
	"\vstring_vals\x18\x0f \x03(\tR\n" +
	"stringVals\x12=\n" +
	"\x1blow_cardinality_string_vals\x18\x10 \x03(\tR\x18lowCardinalityStringVals\x12)\n" +
	"\x10utcdatetime_vals\x18\x11 \x03(\aR\x0futcdatetimeVals\x127\n" +
	"\x17steamidtrustbucket_vals\x18\x12 \x03(\x06R\x16steamidtrustbucketVals\x12a\n" +
	"\x10trustbucket_vals\x18\x13 \x03(\v26.dota.CMsgSource2PlayStatsPackedRecordList.SteamIDListR\x0ftrustbucketVals\x1aj\n" +
	"\bFieldDef\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12?\n" +
	"\n" +
	"field_type\x18\x02 \x01(\x0e2 .dota.ESource2PlayStatsFieldTypeR\tfieldType\x1a'\n" +
	"\vSteamIDList\x12\x18\n" +
	"\asteamid\x18\x01 \x03(\x06R\asteamid\"\x93\x01\n" +
	",CSource2Metrics_RecordPlayStats_Notification\x12M\n" +
	"\frecord_types\x18\x01 \x03(\v2*.dota.CMsgSource2PlayStatsPackedRecordListR\vrecordTypes\x12\x14\n" +
	...
	"\ttime_span\x18\x06 \x01(\rR\btimeSpan\"\xbd\x01\n" +
	"%CSource2Metrics_FetchMapData_Response\x12M\n" +
	"\aresults\x18\x01 \x03(\v23.dota.CSource2Metrics_FetchMapData_Response.MapDataR\aresults\x1aE\n" +
	"\aMapData\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x12\n" +
	"\x04data\x18\x03 \x01(\tR\x04data*\xb2\x04\n" +
	...
	"&Source2PlayStats_SteamIDTrustBucketMin\x10\x10B-Z+dota2-collector/parser/internal/valve;valve"
...
var file_source2_steam_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_source2_steam_stats_proto_goTypes = []any{
	(ESource2PlayStatsFieldType)(0),                              // 0: dota.ESource2PlayStatsFieldType
	(*CMsgSource2SystemSpecs)(nil),                               // 1: dota.CMsgSource2SystemSpecs
	(*CMsgSource2VProfLiteReportItem)(nil),                       // 2: dota.CMsgSource2VProfLiteReportItem
	(*CMsgSource2VProfLiteReport)(nil),                           // 3: dota.CMsgSource2VProfLiteReport
	(*CMsgSource2NetworkFlowQuality)(nil),                        // 4: dota.CMsgSource2NetworkFlowQuality
	(*CMsgSource2PerfIntervalSample)(nil),                        // 5: dota.CMsgSource2PerfIntervalSample
	(*CSource2Metrics_MatchPerfSummary_Notification)(nil),        // 6: dota.CSource2Metrics_MatchPerfSummary_Notification
	(*CMsgSource2PlayStatsPackedRecordList)(nil),                 // 7: dota.CMsgSource2PlayStatsPackedRecordList
	(*CSource2Metrics_RecordPlayStats_Notification)(nil),         // 8: dota.CSource2Metrics_RecordPlayStats_Notification
	(*CSource2Metrics_FetchMapData_Request)(nil),                 // 9: dota.CSource2Metrics_FetchMapData_Request
	(*CSource2Metrics_FetchMapData_Response)(nil),                // 10: dota.CSource2Metrics_FetchMapData_Response
	(*CMsgSource2PerfIntervalSample_Tag)(nil),                    // 11: dota.CMsgSource2PerfIntervalSample.Tag
	(*CSource2Metrics_MatchPerfSummary_Notification_Client)(nil), // 12: dota.CSource2Metrics_MatchPerfSummary_Notification.Client
	(*CMsgSource2PlayStatsPackedRecordList_FieldDef)(nil),        // 13: dota.CMsgSource2PlayStatsPackedRecordList.FieldDef
	(*CMsgSource2PlayStatsPackedRecordList_SteamIDList)(nil),     // 14: dota.CMsgSource2PlayStatsPackedRecordList.SteamIDList
	(*CSource2Metrics_FetchMapData_Response_MapData)(nil),        // 15: dota.CSource2Metrics_FetchMapData_Response.MapData
}
var file_source2_steam_stats_proto_depIdxs = []int32{
	2,  // 0: dota.CMsgSource2VProfLiteReport.total:type_name -> dota.CMsgSource2VProfLiteReportItem
	2,  // 1: dota.CMsgSource2VProfLiteReport.items:type_name -> dota.CMsgSource2VProfLiteReportItem
	11, // 2: dota.CMsgSource2PerfIntervalSample.tags:type_name -> dota.CMsgSource2PerfIntervalSample.Tag
	3,  // 3: dota.CSource2Metrics_MatchPerfSummary_Notification.server_profile:type_name -> dota.CMsgSource2VProfLiteReport
	12, // 4: dota.CSource2Metrics_MatchPerfSummary_Notification.clients:type_name -> dota.CSource2Metrics_MatchPerfSummary_Notification.Client
	13, // 5: dota.CMsgSource2PlayStatsPackedRecordList.field_defs:type_name -> dota.CMsgSource2PlayStatsPackedRecordList.FieldDef
	14, // 6: dota.CMsgSource2PlayStatsPackedRecordList.trustbucket_vals:type_name -> dota.CMsgSource2PlayStatsPackedRecordList.SteamIDList
	7,  // 7: dota.CSource2Metrics_RecordPlayStats_Notification.record_types:type_name -> dota.CMsgSource2PlayStatsPackedRecordList
	15, // 8: dota.CSource2Metrics_FetchMapData_Response.results:type_name -> dota.CSource2Metrics_FetchMapData_Response.MapData
	1,  // 9: dota.CSource2Metrics_MatchPerfSummary_Notification.Client.system_specs:type_name -> dota.CMsgSource2SystemSpecs
	3,  // 10: dota.CSource2Metrics_MatchPerfSummary_Notification.Client.profile:type_name -> dota.CMsgSource2VProfLiteReport
	4,  // 11: dota.CSource2Metrics_MatchPerfSummary_Notification.Client.downstream_flow:type_name -> dota.CMsgSource2NetworkFlowQuality
	4,  // 12: dota.CSource2Metrics_MatchPerfSummary_Notification.Client.upstream_flow:type_name -> dota.CMsgSource2NetworkFlowQuality
	5,  // 13: dota.CSource2Metrics_MatchPerfSummary_Notification.Client.perf_samples:type_name -> dota.CMsgSource2PerfIntervalSample
	0,  // 14: dota.CMsgSource2PlayStatsPackedRecordList.FieldDef.field_type:type_name -> dota.ESource2PlayStatsFieldType
